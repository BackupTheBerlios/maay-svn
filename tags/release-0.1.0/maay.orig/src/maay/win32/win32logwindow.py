...
class LogWindow:
    ...
    def _GetDialogTemplate(self, dlgClassName):
        ...
        s = cs
        dlg.append(['STATIC', "Log", IDC_STATIC_LOG, (5, 10, WINDOW_WIDTH - 10, 10), s])
        ...
        dlg.append(['EDIT', self.__log, IDC_EDIT_LOG, (5, 20, WINDOW_WIDTH - 10, 80), s])
